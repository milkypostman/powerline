...
(defun powerline-default-theme ()
  ...
  (setq-default mode-line-format
			  ...
			  (rhs (eval `(list (powerline-raw global-mode-string face2 'r)
					    (funcall separator-right face2 face1)
					    (unless window-system
					      (powerline-raw (char-to-string #xe0a1) face1 'l))
			  		    ;; Show page number instead of buffer position with pdf-tools
					    ,@(if (eq major-mode 'pdf-view-mode)
						  (list (powerline-raw mode-line-position face1 'l)
							(powerline-raw " " face1))
						(list (powerline-raw "%4l" face1 'l)
		  ...
		  (:eval
		   (let* ((active (powerline-selected-window-active))
			  ...
			  (lhs (list (powerline-raw "%*" nil 'l)
				     ...
				     (powerline-narrow face1 'l)
				     (powerline-vc face1)))
			  (rhs (eval `(list (powerline-raw global-mode-string face1 'r)
			  		    ;; Show page number instead of buffer position with pdf-tools
					    ,@(if (eq major-mode 'pdf-view-mode)
						  (list (powerline-raw mode-line-position face1 'l)
							(powerline-raw " " face1))
